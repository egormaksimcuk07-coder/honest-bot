...
WEBAPP_URL = "https://honeststore.netlify.app/?v=3"
SUPPORT = "Honest_KaS"
OWNER_ID = 1925395566
...
def main_keyboard():
    ...
    kb.add(types.KeyboardButton("🛍 Открыть магазин", web_app=types.WebAppInfo(WEBAPP_URL)))
...
def catalog_inline():
    ...
    kb.add(types.InlineKeyboardButton("🛍 Открыть магазин", web_app=types.WebAppInfo(WEBAPP_URL)))
    return kb
